...
public class OwnerRegister extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("WELCOME TO OUR ROOM BOOKING APPLICATION");
    ...
    private void RegisterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RegisterActionPerformed
        ...
        try {
            ...
            String query = "insert into owner values("+"\""+CUserName.getText()+"\""+","+"\""+Cpassword.getText()+"\""+","+"\""+CEmail.getText()+"\""+","+"\""+CMobile.getText()+"\""+");";
